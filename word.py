...
if __name__ == "__main__":
    # -------------------------- 配置参数（修改这里即可） --------------------------
    WORD_TEMPLATE_PATH = "家庭承包制模板.docx"  # 你的Word模板路径
    ...
    all_family_data = [
        # 案例1：三口之家（户主+配偶+子女）
        {
            ...
            "tables_data": {
                "家庭成员": [
                    {"姓名": "张三", "性别": "男", "年龄": "45", "关系": "户主", "身份证": "110105198101011234", "是否承包": "是"},
                    {"姓名": "李梅", "性别": "女", "年龄": "42", "关系": "配偶", "身份证": "110105198402025678", "是否承包": "是"},
                    {"姓名": "张小明", "性别": "男", "年龄": "18", "关系": "长子", "身份证": "110105200803039012", "是否承包": "是"}
                ]
            }
        },
        # 案例2：单人家庭（孤寡老人，仅户主1人）
        {
            ...
            "tables_data": {
                "家庭成员": [
                    {"姓名": "王老太", "性别": "女", "年龄": "78", "关系": "户主", "身份证": "310115194805056789", "是否承包": "是"}
                ]
            }
        },
        # 案例3：五口之家（户主+配偶+2子女+老人）
        {
            "text_data": {
                "{户主姓名}": "刘建国",
                "{家庭住址}": "广州市天河区天河路385号",
            ...
            "tables_data": {
                "家庭成员": [
                    {"姓名": "刘建国", "性别": "男", "年龄": "48", "关系": "户主", "身份证": "440106197808081234", "是否承包": "是"},
                    {"姓名": "陈秀兰", "性别": "女", "年龄": "45", "关系": "配偶", "身份证": "440106198109095678", "是否承包": "是"},
                    {"姓名": "刘志强", "性别": "男", "年龄": "20", "关系": "长子", "身份证": "440106200603039012", "是否承包": "是"},
                    {"姓名": "刘美丽", "性别": "女", "年龄": "16", "关系": "长女", "身份证": "440106201005053456", "是否承包": "否"},
                    {"姓名": "刘老夫", "性别": "男", "年龄": "72", "关系": "父亲", "身份证": "440106195402027890", "是否承包": "否"}
                ]
            }
        }
    ]
